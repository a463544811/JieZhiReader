...
//    [self.view setBackgroundColor:[LSYReadConfig shareInstance].theme];
    if ([TJZUtil textViewColor]) {
        [self.view setBackgroundColor:[UIColor colorWithHex:[TJZUtil textViewColor]]];
    }else{
       [self.view setBackgroundColor:[UIColor colorWithHex:@"ebf0f2"]];
    }
...
//    [self.view setBackgroundColor:[LSYReadConfig shareInstance].theme];
    NSString * colorStr = no.object;
    [TJZUtil textViewBackColor:colorStr];
    [self.view setBackgroundColor:[UIColor colorWithHex:colorStr]];
}
