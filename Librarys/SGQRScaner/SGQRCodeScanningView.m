...
#pragma mark - - - 扫描外部View的创建
    ...
    promptLabel.font = [UIFont boldSystemFontOfSize:16.0];
    promptLabel.textColor = [[UIColor whiteColor] colorWithAlphaComponent:1.0];
    promptLabel.text = @"对准二维码扫描";
...
//    [light_button setTitle:@"开启闪光灯" forState:UIControlStateNormal];
//    [light_button setImage:[UIImage imageNamed:@"scan_light"] forState:UIControlStateNormal];
//    [light_button setTitle:@"关闭闪光灯" forState:UIControlStateSelected];
